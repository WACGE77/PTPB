...
class SessionLogViewSet(django_filters.rest_framework.FilterSet):
    resource = django_filters.CharFilter(field_name='resource__username', lookup_expr='icontains')
    user = django_filters.CharFilter(field_name='user__username', lookup_expr='icontains')
    ip = django_filters.CharFilter(field_name='ip', lookup_expr='icontains')
    ...
    class Meta:
        model = SessionLog
        fields = ['resource', 'user', 'ip', 'start_time', 'end_time']